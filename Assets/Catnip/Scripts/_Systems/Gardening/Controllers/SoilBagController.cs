...
public class SoilBagController : NetworkBehaviour, IUsable {
    [Header("Soil Pouring Settings")]
    ...
    [Command]
    private void CmdServerUseInternal() {
        PerformSoilCast();
    }
